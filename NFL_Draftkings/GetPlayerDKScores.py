...
def get_stats(name=None, position=None, team=None, week=None, season=None):
    data = get_player_stats(name=name, position=position, team=team, week=week, season=season)
    for d in data:
        d['stats'] = convert_to_DK(d)
    return data

def get_weekly_stats(name=None, position=None, team=None, weeks=None, season=None):
...
def get_top_performers(position=None, team=None, week=None, season=None, top=10):
    data = get_stats(position=position, team=team, week=week, season=season)
